export default function WorkExperience() {
  return (
    <div className="flex flex-col justify-start items-start max-w-xl gap-y-2 font-switzer">
      <div className="text-neutral-900 text-xl font-semibold">About</div>
      <div className="text-neutral-600 leading-6 text-lg ">
        ...
        <br />I thrive on transforming ideas into reality, whether it's crafting
